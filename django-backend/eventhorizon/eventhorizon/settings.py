...
ASGI_APPLICATION = "eventhorizon.asgi.application"

DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://eventhorizon:eventhorizon@localhost:5432/eventhorizon")
...
EVENTHORIZON_CONTRACT_ID = os.getenv("EVENTHORIZON_CONTRACT_ID", "")
